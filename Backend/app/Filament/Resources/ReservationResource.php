        ...
        return $table
            ...
            ->actions([
                Tables\Actions\Action::make('confirm')
                    ...
                    ->action(function (Reservation $record) {
                        ...
                        \Filament\Notifications\Notification::make()
                            ...
                            ->body("Reservation {$record->reference} has been confirmed.")
                            ->send();
                    }),
                Tables\Actions\Action::make('cancel')
                    ...
                    ->color('danger')
                    ->visible(fn (Reservation $record): bool => in_array($record->status, [ReservationStatus::PENDING, ReservationStatus::CONFIRMED]))
                    ->requiresConfirmation()
                    ->action(function (Reservation $record) {
                        try {
