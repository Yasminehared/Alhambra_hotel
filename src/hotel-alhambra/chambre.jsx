...
const rooms = [
  ...
  {
    id: 106, name: "Simple Standard", floor: 1, type: "standard",
    status: "maintenance", guest: null, img: "https://images.unsplash.com/photo-1590490360182-c33d57733427?w=600&q=80",
    checkout: null, checkin: null, nights: null,
    features: ["Queen Bed", "City View"], price: 7500,
    housekeeping: "maintenance", note: "AC replacement in progress",
  },
  {
  ...
  {
    id: 303, name: "Double Deluxe", floor: 3, type: "double",
    status: "maintenance", guest: null, img: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=600&q=80",
    checkout: null, checkin: null, nights: null,
    features: ["King Bed", "Garden View"], price: 8500,
    housekeeping: "maintenance", note: "Plumbing issue — estimated 4h",
  },
  {
...
const STATUS_META = {
  ...
  maintenance: { label: "Maintenance", color: "#dc2626", bg: "rgba(220,38,38,0.1)",   dot: "#dc2626" },
};
...
const NAV_ITEMS = [
  ...
  { icon: <CalIcon />,  label: "Reservations", to: "/Reservations" },
  { icon: <BedIcon />,  label: "Chambres", to: "/Chambres", active: true },
        ...
        <div className="main">
          ...
          <div className="kpi-strip">
            ...
            <div className="kpi-card">
              ...
              <div className="kpi-val" style={{ color: "#d97706" }}>{counts.cleaning + counts.maintenance}</div>
              <div className="kpi-label">Not Ready</div>
              <div className="kpi-trend" style={{ color: "#d97706" }}>{counts.cleaning} cleaning · {counts.maintenance} maintenance</div>
            </div>
            <div className="kpi-card">
              <div className="kpi-icon" style={{ background: "rgba(184,150,90,0.1)" }}>💰</div>
          ...
          <div className="filter-bar">
            {[
              ...
              { key: "maintenance", label: "Maintenance", dot: "#dc2626" },
            ].map(f => (
              <button key={f.key}
                  ...
                  <div className="room-body">
                    ...
                    <div className="room-actions" onClick={e => e.stopPropagation()}>
                      ...
                      {room.status === "maintenance" && <>
                        <button className="action-btn danger">En Cours</button>
            ...
            <div className="modal-body">
              ...
              <div className="modal-actions">
                ...
                {selectedRoom.status === "maintenance" && <>
                  <button className="modal-action-btn" style={{ background: "#dc2626", color: "white" }}>Update Status</button>
                  <button className="modal-action-btn" style={{ background: "white", color: DARK, border: "1px solid #ddd" }}>Mark Resolved</button>
                </>}
              </div>
            </div>
          </div>
...
function ChartIcon() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>;
}
function StarIcon() {
