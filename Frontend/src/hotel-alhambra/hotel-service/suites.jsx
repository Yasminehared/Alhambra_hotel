          ...
          {SUITES.map((suite, i) => (
            ...
            >
              ...
              <div className="suite-image-wrap">
                <img src={suite.image} alt={suite.name} className="suite-img" />
              </div>
            </div>
          ))}
        </section>
